...
![Example of a worksheet for calculating volumes (µl) of PCR products and H~2~0 to get 200 fmol in 11.5 µl, required as input for each sample with the Native Barcoding Kit](./img/PCR_C1V1.png){width="300"}
...
![The Native Barcode Kit comes with 96 individual barcodes](./img/barcode_ligation.png){width="300"}
...
5.  Setting up the run and press start!
